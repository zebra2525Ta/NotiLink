...
- messageはNaviからの追加メッセージ（必ず150文字以上200文字以下で書くこと。くだけた友達トーンで心配・励まし・応援を3〜4文で。情報を添えながら気持ちを伝えること。短すぎるのは絶対にNG。必ず！で終わること）
- 例（150文字以上の正しい例）: "ねえ、今日の夕方から雨らしいよ！朝は晴れてるから忘れがちだけど、傘持ってかないと帰り道びしょ濡れになっちゃうよ！心配で言いたくなっちゃった。気をつけて帰ってきてね！無理しないようにね"
- 例（150文字以上の正しい例）: "牛乳まだ買えてないんじゃないかと思って！帰り道にスーパー寄れそうだったら買ってきてね。買い物リストにまだ残ってるから、ちゃんと確認してね！忘れがちだから言っとくね、ほんとに心配性でごめんね"
- JSONのみ・前置き不要
