                ...
                {weather.forecast && (
                  <div style={{ display: "flex", gap: 4, marginTop: 10, overflowX: "auto" }}>
                    {weather.forecast.map((slot, i) => (
                      <div key={i} style={{ flex: "0 0 auto", minWidth: 62, textAlign: "center", padding: "6px 8px", background: S.bg, borderRadius: 8, border: `0.5px solid ${S.border}` }}>
            ...
            <>
              ...
              {weather.forecast && (
                <div style={{ display: "flex", gap: 3, marginTop: 10 }}>
                  {weather.forecast.map((slot, i) => (
                    <div key={i} style={{ flex: 1, textAlign: "center", padding: "6px 10px", background: S.surf, borderRadius: 6, border: `0.5px solid ${S.border}` }}>
